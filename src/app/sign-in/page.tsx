...
const SignIn = () => {
  ...
  useEffect(() => {
    ...
    // Enable the button only if both email and password are valid
                  ...
                  <div className="overflow-hidden opacity-100 scale-100">
                    <div className="w-[26rem] px-1">
                      ...
                      <div className="w-full pt-6 text-center text-[14px]">
                        <div className="text-[#585c62]">
                          By proceeding, you agree to our{" "}
                          <Link
                            target="_blank"
                            className="text-black dark:text-[#9a9ea7] font-medium dark:font-normal hover:underline"
